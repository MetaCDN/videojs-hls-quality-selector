  ...
  var ConcreteButton = (function (_VideoJsButtonClass) {
    ...
    function ConcreteButton(player) {
      ...
      return possibleConstructorReturn(
        this,
        new _VideoJsButtonClass(player, {
  ...
  var HlsQualitySelectorPlugin = (function () {
    ...
    HlsQualitySelectorPlugin.prototype.getQualityMenuItem =
      function getQualityMenuItem(item) {
        ...
        var menuItem = new ConcreteMenuItem(player, {
          label: item.label,
          selectable: true,
          selected: item.selected || false,
        });
        menuItem.item = item;
        menuItem.qualityButton = this._qualityButton;
        menuItem.plugin = this;
    ...
    HlsQualitySelectorPlugin.prototype.getCurrentQuality =
